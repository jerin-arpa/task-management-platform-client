        ...
        <div className="py-10">
            <div className="flex justify-center my-12 container mx-auto px-5">
                <div className="bg-gray-100 rounded-xl w-full md:w-3/4 lg:w-2/4 py-8">
                    <h2 className="text-3xl font-bold text-center pt-10 pb-5"><span className="text-amber-500">Login</span> your account</h2>
                    <form onSubmit={handleLogin} className="px-4 md:px-14">
                        ...
                        <div className="form-control mt-6">
                            <button className="btn bg-amber-500 border-amber-500 hover:bg-white hover:text-amber-500 text-white font-bold">Login</button>
                        </div>
                    ...
                    <div className="flex justify-center mb-4">
                        <h2 className="text-xs md:text-lg mt-6 md:mt-8 mb-6">Do not have an account? <Link to='/signup' className="text-amber-500 underline font-bold">SignUp</Link></h2>
                    </div>
                </div>
            </div>
        </div>
